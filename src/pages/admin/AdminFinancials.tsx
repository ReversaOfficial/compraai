...
const payouts = [
  { store: 'Moda Bella', amount: 3200, commission: 320, status: 'paid', date: '01/04' },
  { store: 'TechZone', amount: 5400, commission: 540, status: 'paid', date: '01/04' },
  { store: 'Casa Viva', amount: 1800, commission: 180, status: 'pending', date: '15/04' },
  { store: 'Sabor da Terra', amount: 2100, commission: 210, status: 'pending', date: '15/04' },
  { store: 'Bella Pele', amount: 2900, commission: 290, status: 'pending', date: '15/04' },
];
    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 grid-cols-2 lg:grid-cols-4">
        <Card className="shadow-card"><CardContent className="p-4">
          ...
          <p className="text-2xl font-bold">{fmt(142580)}</p><p className="text-xs text-muted-foreground">Receita Total</p>
        </CardContent></Card>
        <Card className="shadow-card"><CardContent className="p-4">
          ...
          <p className="text-2xl font-bold">{fmt(14258)}</p><p className="text-xs text-muted-foreground">Comissão Total</p>
        </CardContent></Card>
        <Card className="shadow-card"><CardContent className="p-4">
          ...
          <p className="text-2xl font-bold">{fmt(6800)}</p><p className="text-xs text-muted-foreground">Repasses Pendentes</p>
        </CardContent></Card>
        <Card className="shadow-card"><CardContent className="p-4">
          ...
          <p className="text-2xl font-bold">{fmt(8600)}</p><p className="text-xs text-muted-foreground">Repasses Realizados</p>
        </CardContent></Card>
      </div>
